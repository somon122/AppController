...
public class MyWorkUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_work_upload);
    ...
    private void isPermission(){
        if (Build.VERSION.SDK_INT >= 23){
            if (ActivityCompat.checkSelfPermission(MyWorkUploadActivity.this,android.Manifest.permission.READ_EXTERNAL_STORAGE)
                ...
                CropImage.activity()
                        ...
                        .start(MyWorkUploadActivity.this);
            }
    ...
    private void uploadMyWorkImage(){
        ...
        if (description.isEmpty()){
            ...
            if (accountImageUri != null){
                ...
                StorageReference riversRef = mStorageRef.child(accountImageUri.getLastPathSegment()).child(".jpg");
                riversRef.putBytes(newImageData).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()){
                            ...
                            myWorkClass = new MyWorkClass(imageUrl,description);

                            String uploadId = myRef.push().getKey();

                            myRef.child("MyWork").child(uploadId).setValue(myWorkClass).addOnCompleteListener(MyWorkUploadActivity.this,new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){

                                        progressDialog.dismiss();
                                        Intent intent = new Intent(MyWorkUploadActivity.this, MainActivity.class);
                                        ...
                                        progressDialog.dismiss();
                                        Toast.makeText(MyWorkUploadActivity.this, "Please check your Net connection", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
