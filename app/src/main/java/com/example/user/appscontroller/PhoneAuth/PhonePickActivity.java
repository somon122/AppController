package com.example.user.appscontroller.PhoneAuth;
...
public class PhonePickActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_pick);
        ...
        sentCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (haveNetwork()){
                    ...
                    Toast.makeText(PhonePickActivity.this, "Net connection is Error", Toast.LENGTH_SHORT).show();
                }
    ...
    private void phoneAuthentication(){
        ...
        if (phoneNumber.isEmpty() || phoneNumber.length()<10){
            ...
            Intent intent = new Intent(PhonePickActivity.this,PhoneConfirmActivity.class);
